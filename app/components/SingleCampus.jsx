...
function SingleCampus(props) {
  const { handleChange,updateCampus,campusId, campuses , students , handleOnClick, handleSubmit} = props;
  ...
  return (
    ...
    <br/>
      ...
      <div className="form-group">
        <label htmlFor="name">Update Campus Name
      ...
      <div className="form-group">
          ...
          campuses.map(campus => {
            ...
            <button type="submit" className={campus.id + "|" + campus.name}>Update</button>
            );
          })}
      </div>
    </form>
...
const mapDispatchToProps = function(dispatch, ownProps) {
  return {
    ...
    handleSubmit(evt)
    {
      ...
      dispatch(updateCampusM(updateCampusM,evt.target.campusName.className, ownProps.history));
