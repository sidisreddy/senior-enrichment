...
export function fetchStudents() {return function thunk(dispatch) {
...
export function postStudent(student) {    return function thunk(dispatch) {
    return axios
...
export function updateCampusM(campusName, campusId, history) {
  return function thunk(dispatch) {
    ...
    return axios.put(callRequest, campusName).then(res => res.data).then(campus => {
      const action = removeCampus(campus);
      dispatch(action);
...
export function updateStudentM(studentName, studentId, history) {
  return function thunk(dispatch) {
    console.log("UPDATE COMING")
    var callRequest = "/api/campus/" + campusId;
    return axios.put(callRequest, {studentName}).then(res => res.data).then(campus => {
      const action = removeCampus(campus);
      dispatch(action);
      var reDirect = "/campus/" + campusId
      history.push(reDirect);
